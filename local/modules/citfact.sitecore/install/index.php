...
class citfact_sitecore extends CModule
{
    /**
     * @var string
     */
    public $MODULE_ID = 'citfact.sitecore';
    ...
    {
        $this->MODULE_NAME = Loc::getMessage('SITECORE_MODULE_NAME');
        $this->MODULE_DESCRIPTION = Loc::getMessage('SITECORE_MODULE_DESCRIPTION');
    ...
    public function doInstall()
    {
        ...
        RegisterModuleDependences("main", "OnBuildGlobalMenu", $this->MODULE_ID, "CitfactSitecoreModuleEventsHandler", "OnBuildGlobalMenuHandler");
        $this->installFiles();
        $this->installDB();
        $this->installEvents();
    }
    ...
    public function doUninstall()
    {
        ...
        UnRegisterModuleDependences("main", "OnBuildGlobalMenu", $this->MODULE_ID, "CitfactSitecoreModuleEventsHandler", "OnBuildGlobalMenuHandler");
